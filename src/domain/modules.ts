...
export const MODULES: AppModule[] = [
  ...
  { href: '/config', label: 'Config Explorer', icon: 'file-cog-outline', group: 'On site',
    blurb: 'Open a panel configuration on the phone and read it. Nothing is written into a site.',
  ...
  { href: '/work/stock-list', label: 'Stock to load', icon: 'clipboard-list-outline', group: 'On site',
    blurb: 'What the next few days of booked work needs, less what is already in the van.',
    keywords: ['stock list', 'load', 'pick list', 'parts', 'week ahead', 'defects', 'order'] },
